                        ...
                        <?php if ($thread->UserID == $this->session->userdata('id_user')) : ?>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href="<?= base_url() ?>discussionguru/editdiskusi/<?= $thread->ForumQID ?>/<?= $CourseID ?>">Edit</a></li>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content modal-warning">
                                            <div class="modal-body text-center">
                                                ...
                                                <a href="<?= base_url() ?>discussionguru/delete/<?= $thread->ForumQID ?>/<?= $thread->CourseID ?>" class="btn btn-warning btn-sm me-5">Hapus</a>
                        ...
                        <div class="card-body">
                            <?php foreach ($comments as $row) : ?>
                                <div class="row ">
                                    ...
                                    <div class="w-80">
                                        <p class="card-title text-white fw-bold mb-0"><?= $row->UserName ?> . <span class="me-3 fw-light text-secondary small"><?= date("d M Y, H:i", strtotime($row->time_answer));  ?></span></p>
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content modal-warning">
                                                            <div class="modal-body text-center">
                                                                ...
                                                                <a href="<?= base_url() ?>discussionguru/deletecomment/<?= $thread->CourseID ?>/<?= $row->ForumQID ?>/<?= $row->ForumAID ?>" class="btn btn-warning btn-sm me-5">Hapus</a>
                                                                <button type="button" class="btn btn-dark btn-sm " data-bs-dismiss="modal">Batal</button>
