            ...
            <div class="card">
                <div class="card-body pt-0 p-3 ">
                    <div class="row">
                        <div class="col-md-3">
                            <div
                                class="icon icon-shape icon-lg bg-gradient-primary shadow text-center border-radius-md mt-3">
                                <i class="fas fa-landmark opacity-10" aria-hidden="true"></i>
                            </div>
                        </div>
                        <div class="col-md-9">
                            <h6 class=" mb-0 mt-3 text-light">Basis Data</h6>
                            <div class="progress mt-3">
                                <div class="progress-bar" role="progressbar" style="width: 25%; height:17px" aria-valuenow="25"
            ...
            <div class="card">
                <div class="card-body pt-0 p-3 ">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <h6 class=" mb-0 mt-3 text-light">Pemrograman Berorientasi Objek</h6>
                            <div class="progress mt-3">
                                <div class="progress-bar" role="progressbar" style="width: 50%; height:17px" aria-valuenow="25"
                                    aria-valuemin="0" aria-valuemax="100">25%</div>
                            </div>
                        </div>
                    </div>
